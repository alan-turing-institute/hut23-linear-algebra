...
Every operator or an odd-dimensional vector space has an eigenvalue.
\end{result}
...
\begin{definition}{5.36}[matrix of an operator, $\M(T)$]
...
\item[(b)] $\vspan(v_1, \ldots, v_n)$ is invariant under $T$ for each $k = 1, \ldots, n$.
