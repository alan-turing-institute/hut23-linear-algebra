...
Suppose $T \in \L(V, W)$. The \defn{singular values} of $T$ are the nonegative square roots of teh eigenvalues of $T^* T$, listed in decreasing order, each included as many times as the dimension of the corresponding eigenspace of $T^* T$.
\end{definition}
