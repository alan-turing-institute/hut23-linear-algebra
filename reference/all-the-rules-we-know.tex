...
\item[(c)] $\inner{u}{v} = \inner{u}{e_1} \overline{\inner{v}{e_1}} + \inner{u}{e_n} \overline{\inner{v}{e_n}}.$
\end{enumerate}
\end{result}
...
$$
For each $k = 1, \ldots, m$, let $e_k = \frac{f_k}{\norm{f_k}}$. Then $e_1, \ldots, e_m$ is an orthonormal list of vectors $V$ such tat
$$
