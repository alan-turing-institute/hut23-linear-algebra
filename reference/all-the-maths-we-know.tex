...
%% 
%%
\title{All we know about vector spaces}
\author{}
...
\begin{tabularx}{\columnwidth}{@{}l>{\raggedright\arraybackslash}X@{}}
  ...
  \defn{Pseudoinverse}
                     & For $V$ finite-dimensional and $T\in\mathcal{L}(V, W)$. The pseudoinverse $T^\dag \in\mathcal{L}(W,V)$ is
                       \begin{equation*}
                         T^\dag w = (T|_{(\operatorname{null} T)_\perp})^{-1} P_{\operatorname{range} T} w.
                                           \end{equation*}
