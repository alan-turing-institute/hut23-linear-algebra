...
The right-hand side is $\mathbf{0}$ by Axler 1.30, as we noted at the
beginning. The left hand side clearly ought to be $\mathbf{v}$---and it is,
because $(1/a)(a\mathbf{v}) = (a/a)\mathbf{v}$ by distributivity. 
